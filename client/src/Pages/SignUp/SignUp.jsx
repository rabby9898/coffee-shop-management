      ...
      .then((res) => {
        ...
        fetch(
          ...
          .then((data) => {
            console.log(data);
            if (data.insertedId) {
              Swal.fire("Thanks!", "Signed Up Successfully!", "success");
            }
            form.reset();
          });
      })
  ...
  return (
    <div>
      <div className="text-center py-10 w-[700px] mx-auto">
        <h1 className="text-4xl text-black font-bold">Sign Up Your Account</h1>
      </div>
      <form onSubmit={handleSignUp} className="w-[600px] mx-auto">
