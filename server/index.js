...
async function run() {
  try {
    ...
    //_______________Coffee Details Info_____________________________
    // CREATE OPERATION
    app.post("/coffee", async (req, res) => {
      const coffeeShop = req.body;
      console.log(coffeeShop);
      const result = await coffeeCollection.insertOne(coffeeShop);
      res.send(result);
    });
    // READ OPERATION
    ...
    //_______________User Details Info________________________
